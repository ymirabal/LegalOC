                      ...
                      <div class="card">
                        <div class="card-header">
                          <div class="row align-items-center">
                            <div class="col-8">
                              <h3 class="mb-0">Nueva entidad</h3>
                            </div>
                        ...
                        <div class="card-body">
                          {!! Form::open(['route'=>'admin.entities.store']) !!}
                            ...
                            <div class="custom-control custom-checkbox mb-3">
                                {!! Form::checkbox('external', '1', null, ['class'=>'custom-control-input']) !!}  
                            ...
                            {{-- <div class="form-group">
                                {!! Form::checkbox('external', '1', null, ['class'=>'form-control']) !!}  
                                {!! Form::label('external', 'Externa',['class'=>'form-control-label']) !!}
                            </div> --}}
