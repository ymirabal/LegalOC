                      ...
                      <div class="card">
                        <div class="card-header">
                          <div class="row align-items-center">
                            <div class="col-8">
                              <h3 class="mb-0">Editar medida disciplinaria aplicada</h3>
                            </div>
                        ...
                        <div class="card-body">
                            {!! Form::model($disciplinaryAction,['route'=>['law.disciplinaryActions.update',$disciplinaryAction],'method'=>'put']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        {!! Form::label('action_id', 'Medida Disciplinaria Aplicada',['class'=>'form-control-label']) !!}
