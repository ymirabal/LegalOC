            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Editar apelación</h3>
                        </div>
                        <div class="col-4 text-right">
                            @if ($appeal->appealable_type=='App\Models\Responsibility')
                                <a class="btn btn-sm btn-primary" href="{{route('appeals.index',['id'=>$appeal->appealable_id,'type'=>1])}}">Volver</a>
                                
                            @elseif ($appeal->appealable_type=='App\Models\DisciplinaryAction')
                                <a class="btn btn-sm btn-primary" href="{{route('appeals.index',['id'=>$appeal->appealable_id,'type'=>2])}}">Volver</a>                                
                            @endif
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    {!! Form::model($appeal,['route'=>['appeals.update',$appeal],'method'=>'put']) !!}
                        <div class="row">
                            <div class="col-4">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    {!! Form::label('type', 'Tipo de apelación',['class'=>'form-control-label']) !!}
                                    {!! Form::select('type',['OJL'=>'Organo de Justicia Laboral','Superior'=>'Superior','Tribunal'=>'Tribunal'] ,null, ['class'=>'form-control']) !!}
                            ...
                            <div class="col-4">
                                <p class="form-control-label">Decisión</p>                               
