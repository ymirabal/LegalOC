            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Nueva apelación</h3>
                        </div>
                        <div class="col-4 text-right">

                            <a class="btn btn-sm btn-primary" href="{{route('appeals.index',['id'=>$id,'type'=>$type])}}">Volver</a>
                ...
                <div class="card-body">
                    {!! Form::open(['route'=>['appeals.storeAppeal','id'=>$id,'type'=>$type]]) !!}
                        <div class="row">
                            <div class="col-4">
